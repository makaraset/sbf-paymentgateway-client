package com.sbf.paymentgateway.client.config;
...
import com.sbf.paymentgateway.DemoApplicationUtils;
...
public class OauthClientConfig {
	...
	public OAuth2ProtectedResourceDetails fullAccessresourceDetails(String tokenUrl) {
		...
		resource.setClientId("WingClientApp");
		resource.setClientSecret("secret");
		resource.setGrantType("password");
		resource.setScope(DemoApplicationUtils.getScopesList("accountinfo","repayment","read", "write"));
		resource.setUsername("wingcambodia");
